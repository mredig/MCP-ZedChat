...
struct ZedThread: Codable, Sendable {
	let title: String
	let messages: [ZedMessage]
	let updatedAt: String
	let detailedSummary: String?
//	let initialProjectSnapshot: String?
//	let cumulativeTokenUsage: TokenUsage?
//	let requestTokenUsage: TokenUsage?
	let model: Model?
...
//		case initialProjectSnapshot = "initial_project_snapshot"
//		case cumulativeTokenUsage = "cumulative_token_usage"
//		case requestTokenUsage = "request_token_usage"
		case model
...
enum ZedMessage: Codable, Sendable {
